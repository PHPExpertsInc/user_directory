...
INSERT INTO `Profiles` VALUES (2,2,'Mark','Jenssen','mark@givemehope.co.uk'),(3,3,'Daniel','Jackson','djackson@sgc.mil'),(4,4,'Vala','Mal Doran','vmaldoran@sgc.mil'),(5,5,'Jack','O\'Neill','joneill@sgc.mil'),(6,6,'Harold','Landry','hlandry@sgc.mil'),(7,7,'George','Hammond','ghammond@sgc.mil'),(8,8,'Randolf','McKay','rmckay@sgc.mil'),(9,9,'Samantha','Carter','scarter@sgc.mil'),(10,10,'Teal\'C','Jaffa','tealc@sgc.mil'),(11,11,'Elizabeth','Wier','ewier@sgc.mil'),(12,12,'Jonas','Quinn','jquinn@sgc.mil'),(13,13,'Maria','Ortiz','mmmmm@mmmmm.mmm'),(14,1,'Theodore','Smith','theodore@xmule.ws');
...
-- Dump completed on 2009-04-08  5:17:49
